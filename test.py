...
from us_visa.entity.config_entity import ModelEvalutionConfig,ModelPusherConfig
...
model_evalution_artifact = ModelEvalutionArtifact(change_in_score=0.8347597103357473,
                                                  trained_model_path='artifact\\13_08_2024_21_36_06\\trained_models\\model.dill',
                                                  existing_best_model_path='model.dill')
mp = ModelPusher(model_pusher_config=ModelPusherConfig(),
                 model_evalution_artifact=model_evalution_artifact)

mp.initiate_modelpusher_process()